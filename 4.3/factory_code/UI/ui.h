...
LV_IMG_DECLARE(ui_img_1963129022);    // assets\Wizee-ESP32-03-01.png
LV_IMG_DECLARE(ui_img_1415244543);    // assets\wizee_logo_03_160x40.png
LV_IMG_DECLARE(CrowPanel_ESP32_Advance_HMI_43);   
